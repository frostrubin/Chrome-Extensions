var Simplifier = {
	...
	_sim: function(options) {
		if (options['s3-ck-hide-header'] == true) {
		...
		if (options['s3-ck-add-logout'] == true) {
			// Add a Logout button
		...
		if (options['s3-ck-hide-footer'] == true) {
			// Hide the general AWS Footer
			this.hide(this.byId('console-nav-footer'));
		}

		if (options['s3-ck-hide-tagnot'] == true) {
		...
		if (options['s3-ck-hide-oldlink'] == true) {
		...
		if (options['s3-ck-hide-tabper'] == true) {
  		...
  		if (options['s3-ck-hide-tabpercont'] == true) {
	  	...
	  	if (options['s3-ck-hide-tabper'] == true && options['s3-ck-hide-tabpercont'] == true) {
	  	...
	  	if (options['s3-ck-hide-tabprocont'] == true) {
		  	...
		  	if (options['s3-ck-hide-tabprocontadv'] == true) {
	  	...
	  	if (options['s3-ck-hide-tabpro'] == true && options['s3-ck-hide-tabprocont'] == true) {
  			// The Tab and its contents are hidden
	  		// Then there is no point in linking there...
	  	...
	  	if (options['s3-ck-hide-tabmgm'] == true && options['s3-ck-hide-tabmgmcont'] == true) {
  			// The Tab and its contents are hidden
	  		// Then there is no point in linking there...
	  	...
	  	if (options['s3-ck-hide-tabper'] == true      &&  // 1. Permissions tab
	  		options['s3-ck-hide-tabpercont'] == true  &&  //    and its contents
	  		options['s3-ck-hide-tabpro'] == true      &&  // 2. Properties tab
	  		options['s3-ck-hide-tabprocont'] == true  &&  //    and its contents
	  		options['s3-ck-hide-tabmgm'] == true      &&  // 3. Management tab
	  		options['s3-ck-hide-tabmgmcont '] == true     //    and its contents
	  		) {
	  	...
	  	if (options['s3-ck-hide-buckdel'] == true) {
	  	...
	  	if (options['s3-ck-hide-buckemp'] == true) {
  		...
  		if (options['s3-ck-hide-buckcre'] == true) {
